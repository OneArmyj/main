...
public class Activity {
     ...
     */
    public boolean isSameActivity(seedu.planner.model.activity.Activity otherActivity) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof seedu.planner.model.activity.Activity)) {
            return false;
        }

        seedu.planner.model.activity.Activity otherActivity = (seedu.planner.model.activity.Activity) other;
