...
public class JsonAdaptedDay {
     ...
     */
    @JsonCreator
    public JsonAdaptedDay(@JsonProperty("name") String name, @JsonProperty("phone") String phone,
    ...
    /**
     * Converts this Jackson-friendly adapted contacts object into the model's {@code Day} object.
     *
