...
public class UniqueActivityList implements Iterable<Activity> {
    ...
    public void setActivities(seedu.planner.model.activity.UniqueActivityList replacement) {
    ...
    public boolean equals(Object other) {
        return other == this // short circuit if same object
                || (other instanceof seedu.planner.model.activity.UniqueActivityList // instanceof handles nulls
                        && internalList.equals(((seedu.planner.model.activity.UniqueActivityList) other).internalList));
    }
